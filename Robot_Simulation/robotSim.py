...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        x = pos.getX()
        y = pos.getY()
        if self.tiles[(math.floor(x), math.floor(y))] == 'dirty':
            self.tiles[(math.floor(x), math.floor(y))] = 'clean'
            self.clean_tiles += 1
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.room = room
        self.speed = speed
        self.direction = random.random() * 359.999
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        if self.room.isPositionInRoom(newPosition):
            ...
            self.setRobotDirection(random.random() * 359.999)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for num in range(num_trials):
        tot += runTrialWithoutAnimation(num_robots, speed, width, height, min_coverage, robot_type)
...
# print(runSimulation(1, 1.0, 10, 10, .9, 30, StandardRobot))
...
runTrialWithAnimation(10, 1, 30, 20, .8, RandomWalkRobot)
...
showPlot1('Standard vs. Random Walk Robots Cleaning 80% Of a Room', 'Number of Robots', 'Time Steps Required')
...
showPlot2('Varying Room Sizes for 2 Robots', 'Size of Room', 'Time-Steps')
